...
def create_flask_app(config: AppConfig, state: AppStateManager, repository: UserRepository, cli=None) -> Flask:
    ...
    deps = {
        ...
        "get_registration_control": state.get_registration_control,
        ...
        "start_registration_session": state.start_registration_session,
        "cancel_registration_session": state.cancel_registration_session,
        "override_registration_session": state.override_registration_session,
        ...
        "enable_unknown_registration_override": state.enable_unknown_registration_override,
